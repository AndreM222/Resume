...
\begin{Form}
	...
	\subSubSectionTitle{Full-Stack Developer / AI Systems Engineer}{April 2026 - Present}
	...
	\subSectionTitle{IRIS}{Founder, Product Designer \& Software Engineer — 2026 - Present}

	\begin{listBlock}

		\generalItem
		Founded and lead development of IRIS, an AI-powered computer vision platform
		designed to provide accessible vision intelligence through a scalable API
		and user-facing software platform.

		\generalItem
		Architected a cloud-based computer vision infrastructure supporting
		authenticated API access, image processing workflows, model inference,
		and scalable interaction between client applications and AI services.

		\generalItem
		Designed multimodal AI workflows combining computer vision models
		and large language models to transform visual inputs into structured,
		actionable information.

		\generalItem
		Developed the platform architecture around secure API authentication,
		user-specific access tokens, asynchronous processing, and scalable
		backend services for integrating computer vision capabilities into
		external applications.

		\generalItem
		Designed the product as both a developer-facing API platform and
		consumer-facing application, enabling third-party software to integrate
		IRIS computer vision capabilities while providing direct access to
		AI-powered workflows.

		\generalItem
		Established engineering workflows for reproducible model deployment,
		API development, containerized infrastructure, and continuous integration
		and delivery.
	...
	\begin{listBlock}
		...
		designed as a continuity layer across streaming platforms, physical theaters,
		and consumer devices, unifying movie discovery, availability, playback,
		and cross-device viewing experiences.

		\generalItem
		Designed the product architecture around a platform-agnostic coordination model,
		integrating movie metadata, streaming availability, authentication, user profiles,
		session state, and device continuity without owning or redistributing third-party content.

		\generalItem
		Authored a comprehensive technical strategy and product design document
		defining the system architecture, phased product roadmap, monetization strategy,
		platform integration model, compliance requirements, and international expansion strategy.

		\generalItem
		Architected a distributed backend platform using Rust, SeaORM, Axum, PostgreSQL,
		Redis, Supabase, Docker, and Railway to support authentication, real-time
		synchronization, movie metadata aggregation, availability services, and persistent user state.

		\generalItem
		Developed native SwiftUI applications targeting macOS, iOS, iPadOS,
		and watchOS with real-time synchronization, push notifications,
		subscription management, cross-device session continuity,
		and AI-assisted natural-language movie discovery.

		\generalItem
		Designed an AI intelligence layer that translates natural-language viewing intent
		into structured movie discovery and availability queries, connecting recommendations
		directly to actionable viewing paths rather than isolated search results.
	...
	\begin{listBlock}
		...
		as of now 117 stars and going up.\cite{CopilotLualine}
	...
	\begin{listBlock}
        ...
        Gannon University (2023 - 2025).

		\generalItem
		Member, Computer Club,
        Gannon University (2022 - 2025).

        \generalItem
        President, Computer Club,
        Dowal School (High School).
	...
	\begin{listBlock}
		...
		\generalItem
		Backend \& Cloud: Axum, SeaORM, Tokio, PostgreSQL, Redis, Supabase,
