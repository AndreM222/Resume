...
\begin{Form}
	...
	\subSectionTitle{Gannon University}{Pensilvania, Estados Unidos}
	\educationInfo{Licenciatura en Ingeniería de Sistemas Informáticos}{Mayo 2025}

	\subSectionTitle{Harvard University}{En línea}
	\educationInfo{CS50: Introducción a la Ciencia de la Computación}{Diciembre 2022}

	\subSectionTitle{Extreme Networks}{En línea}
	\educationInfo{Introducción a Redes del Futuro}{Mayo 2022}

	\sectionTitle{PUBLICACIONES}

	\begin{listBlock}
		\generalItem
		Mossi, R. A. — “Tag AI-Sandbox,” Proceedings of the ASEE Annual Conference, 2025 (revisión por pares).
	\end{listBlock}
	...
	\begin{listBlock}
		\awardItem{Premio al Desarrollo Escolar}{Reconocimiento por el desarrollo destacado de un videojuego utilizando Blueprints en Unreal Engine 4}{2020}

		\awardItem{Premio al Desarrollo Escolar}{Reconocimiento por el desarrollo destacado de un videojuego utilizando C++ y Unreal Engine 4}{2016}
	\end{listBlock}
