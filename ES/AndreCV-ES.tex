...
\begin{Form}
    ...
    \subsection{\textbf{Dinant, Tegucigalpa, Honduras}}
    ...
    \subsection{\textbf{Gannon University, Pennsylvania, Estados Unidos}}
    ...
    \subsection{\textbf{Yakiniku Byakutan, Tokyo, Japon}}
    ...
    \subsection{\textbf{Harvard University, En Linea}}
    CS50’s Introduction to Computer Science, Diciembre 2022

    \subsection{\textbf{Extreme Networks, En Linea}}
    Introduction to Future Networks, Mayo 2022

    \section{\textbf{HABILIDADES ADICIONALES}}
    \begin{itemize}
    ...
    \section{\textbf{RESUMEN DE CUALIFICACIONES}}
    ...
    \section{\textbf{PREMIOS Y HONORES}}
